...
def find_afterparties():
    ...
    if location and distance and measurement:
        ...
        #querystring="https://www.eventbriteapi.com/v3/events/search/?q={}&sort_by={}&location.address={}&location.within={}+{}&token=AHMVASD2JFHKEEEMUL5W".format(query, sort, location, distance,measurement)
        ...
        response= requests.get('https://www.eventbriteapi.com/v3/events/search/?token=AHMVASD2JFHKEEEMUL5W', params=search_params)


        data = response.json()
        #num_results = data['resultCount']
